...
const Footer = () => {
  ...
  return <footer className='footer'>
    <Container>
      <Row>
        <Col lg='3' md='4' sm='6'>
          <div className="footer__logo text-start">
            ...
            <h5>BEST FOOD !!!</h5>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat, hic labore magnam aliquid rerum blanditiis.</p>
          </div>
        </Col>
      ...
      <Row className='mt-5'>
        <Col lg='6' md='6'>
          <p className='copyright__text'>Copyright - 2022, website made by Our Team.</p>
        </Col>
